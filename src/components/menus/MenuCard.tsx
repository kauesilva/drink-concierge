...
const MenuCard = ({ menu, companyId, index = 0 }: MenuCardProps) => {
  return (
    <motion.div
      ...
      className="group flex flex-col h-full rounded-2xl border border-border bg-card hover:border-primary/30 hover:shadow-gold transition-all duration-300 overflow-hidden"
    >
      {menu.coverImage && (
